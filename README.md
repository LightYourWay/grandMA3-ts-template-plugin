...
- [**grandMA3-toolkit**](https://github.com/LightYourWay/grandMA3-toolkit) - a helpful library of functions and more for grandMA3 LUA plugin development using grandMA3-types.
- [**grandMA3-tsserver-plugin**](https://github.com/LightYourWay/grandMA3-tsserver-plugin) - a TypeScript language server plugin that improves the editor experience for grandMA3 plugin development.
